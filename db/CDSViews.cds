...
context CDSViews {
    ...
    // ![] is used to name view inorder to avoid automatic conversion of any name to uppercase by a system in database.
    ...
    // value help view which provides help to user to choose a view by its description
    ...
    //  creating a base view for po items data
    ...
    // create a view on top of items view(view on view) - in order to increase reusability
